        ...
        <div class="relative mt-12 w-full max-w-lg sm:mt-10">
            ...
            <div
                ...
                <div class="flex flex-col p-6">
                    ...
                    <p class="mt-1.5 text-sm font-medium text-white/50">Hii!
                    </p>
                </div>
                <div class="p-6 pt-0">
                    <form>
                        ...
                        <div class="mt-4">
                            <div>
                                <div
                                    ...
                                    <div class="flex justify-between">
                                        <label
                                            class="text-xs font-medium text-muted-foreground group-focus-within:text-white text-gray-400">Status</label>
                                    </div>
                        ...
                        <div class="mt-4">
                            <div
                                ...
                                <div class="flex justify-between">
                                    <label
                                        class="text-xs font-medium text-muted-foreground group-focus-within:text-white text-gray-400">Phone</label>
                                </div>
                                <div class="flex items-center">
                        ...
                        <div class="mt-4">
                            <div
                                ...
                                <div class="flex justify-between">
                                    <label
                                        class="text-xs font-medium text-muted-foreground group-focus-within:text-white text-gray-400">Prodi</label>
                                </div>
                                <div class="flex items-center">
                                    <input type="prodi" name="prodi"
                                        class="block w-full border-0 bg-transparent p-0 text-sm file:my-1 placeholder:text-muted-foreground/90 focus:outline-none focus:ring-0 focus:ring-teal-500 sm:leading-7 text-foreground">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4 flex items-center justify-end gap-x-5">
                            <a href="{{ route('welcome') }}">
                                <button
                                    class="font-semibold hover:bg-black hover:text-white hover:ring hover:ring-white transition duration-300 inline-flex items-center justify-center rounded-md text-sm focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-offset-4 disabled:pointer-events-none disabled:opacity-50 bg-white text-black h-8 px-4 py-2"
